...
class PlayerGameStatistic(base):
    ...
    __tablename__ = 'nba_player_game_statistic'
    ...
    player = relationship("Player", lazy="subquery",foreign_keys="PlayerGameStatistic.id_player")
    game = relationship("Game", lazy="subquery", foreign_keys="PlayerGameStatistic.id_game")
    team = relationship("Team", lazy="subquery", foreign_keys="PlayerGameStatistic.id_team")
